  ...
  <div class="panel-body">
    ...
    <tbody>
      ...
      <tr>
          ...
          <td><image class="image-responsive" src="{{ url('uploads/'.$doctor->photo) }}" alt="Photo Profile" style="width:60px;height:60px"></td>
          <td>{{ $doctor->f_name }}</td>
          <td>{{ $doctor->l_name }}</td>
          <td>{{ $doctor->phone }}</td>
          <td>{{ $doctor->email}}</td>
          <td><a href="{{ route('doctor.edit',$doctor->id) }}" class="btn btn-primary"><i class="fa fa-edit fa-lg"></i></a></td>
          <td>{!! DoctorController::delete($doctor->id, $doctor->name) !!}</td>
        </td>
      </tr>
      @endforeach
    </tbody>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        {!! Form::hidden('description','This is For Test') !!}
